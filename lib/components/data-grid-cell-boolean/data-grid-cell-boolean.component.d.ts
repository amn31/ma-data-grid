...
export declare class DataGridCellBooleanComponent implements MaDataGridCell, OnInit {
    ...
    constructor();
    ngOnInit(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<DataGridCellBooleanComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<DataGridCellBooleanComponent, "ma-data-grid-cell-boolean", never, { "data": "data"; "col": "col"; }, {}, never, never>;
}
